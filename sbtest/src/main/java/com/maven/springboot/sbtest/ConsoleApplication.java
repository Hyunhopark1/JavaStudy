...
public class ConsoleApplication {
    ...
    public void printTitle() {
        System.out.println("============================================================================");
        System.out.println("1.연락처생성|2.목록|3.수정|4.삭제|5.이름검색|6.그룹검색|7.폰검색|8.이메일검색|9.종료|10.모든 연락처 삭제");
        System.out.println("============================================================================");
    }
    ...
    public void insert(Scanner input) throws Exception {
            ...
            if (this.phoneBookService.insert(name, group, phone, email)) {
                ...
                System.out.println("데이터 추가 실패: 이름은 반드시 입력되어야 합니다");
            }
    ...
    public void allClear() throws Exception {
        ...
        System.out.println("=================모든 연락처가 삭제되었습니다==================");
        phoneBookService.saveData();
    ...
    public void update(Scanner input) throws Exception {
        ...
        String email = this.emailValidity(input);
        IPhoneBook update = PhoneBook.builder().id(result.getId()).name(name).group(group).phoneNumber(phone).email(email).build();
    ...
    public void delete(Scanner input) throws Exception {
        ...
        if (this.phoneBookService.remove(result.getId())) {
            this.phoneBookService.saveData();
            System.out.println("결과: [ID : " + result.getId() + " " + result.getName() + "] 데이터 삭제 성공되었습니다.");
        } else {
    ...
    public void searchByName(Scanner input) {
        ...
        System.out.println("==========[" + name + "]이(가) 포함된 연락처를 모두 표시합니다==========");
    ...
    public void searchByPhone(Scanner input) {
        ...
        System.out.println("==========[" + phone + "]이(가) 포함된 연락처를 모두 표시합니다==========");
        this.printList("해당하는", list);
    }
    ...
    public void searchByEmail(Scanner input) {
        ...
        System.out.println("==========[" + email + "]이(가) 포함된 연락처를 모두 표시합니다==========");
        this.printList("해당하는", list);
    }
}